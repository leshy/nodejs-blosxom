...
(function() {
  var Backbone, Wiki, async, collections, converter, crypto, decorate, decorators, ejslocals, env, express, fs, helpers, hound, http, init, initCollections, initDb, initExpress, initLogger, initRoutes, initRss, initWiki, makeLogDecorator, mongodb, pagedown, path, settings, wraplog, xml, _,
    __slice = [].slice;
